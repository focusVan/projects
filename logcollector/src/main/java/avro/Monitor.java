...
public class Monitor extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<avro.Track> impurl;
   ...
   */
  public Monitor(java.util.List<avro.Track> impurl, java.util.List<CharSequence> clkurl, java.util.List<CharSequence> securl, Integer exptime, java.util.List<CharSequence> exts) {
    this.impurl = impurl;
    this.clkurl = clkurl;
    this.securl = securl;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: impurl = (java.util.List<avro.Track>)value$; break;
   ...
   */
  public java.util.List<avro.Track> getImpurl() {
    return impurl;
  }
   ...
   */
  public void setImpurl(java.util.List<avro.Track> value) {
    this.impurl = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Monitor>
    ...
    private java.util.List<avro.Track> impurl;
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setImpurl(java.util.List<avro.Track> value) {
    ...
    public Monitor build() {
      try {
        ...
        record.impurl = fieldSetFlags()[0] ? this.impurl : (java.util.List<avro.Track>) defaultValue(fields()[0]);
