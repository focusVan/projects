...
public class MediaBid extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public avro.MediaRequest request;
  @Deprecated public avro.MediaResponse response;
   ...
   */
  public MediaBid(Integer status, CharSequence ip, CharSequence impid, Long ts, avro.MediaRequest request, avro.MediaResponse response) {
    this.status = status;
    this.ip = ip;
    this.impid = impid;
    this.ts = ts;
  ...
  public void put(int field$, Object value$) {
    ...
    case 4: request = (avro.MediaRequest)value$; break;
    case 5: response = (avro.MediaResponse)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public avro.MediaRequest getRequest() {
    return request;
  }
   ...
   * @param value the value to set.
   */
  public void setRequest(avro.MediaRequest value) {
    this.request = value;
  }
   ...
   */
  public avro.MediaResponse getResponse() {
    return response;
  }
   ...
   * @param value the value to set.
   */
  public void setResponse(avro.MediaResponse value) {
    this.response = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MediaBid>
    ...
    private long ts;
    private avro.MediaRequest request;
    private avro.MediaRequest.Builder requestBuilder;
    private avro.MediaResponse response;
    private avro.MediaResponse.Builder responseBuilder;
    ...
    private Builder(Builder other) {
      ...
      if (other.hasRequestBuilder()) {
        this.requestBuilder = avro.MediaRequest.newBuilder(other.getRequestBuilder());
      }
      ...
      if (other.hasResponseBuilder()) {
        this.responseBuilder = avro.MediaResponse.newBuilder(other.getResponseBuilder());
      }
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setRequest(avro.MediaRequest value) {
     ...
     * @return This builder.
     */
    public avro.MediaRequest.Builder getRequestBuilder() {
      if (requestBuilder == null) {
        if (hasRequest()) {
          setRequestBuilder(avro.MediaRequest.newBuilder(request));
        } else {
          setRequestBuilder(avro.MediaRequest.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public Builder setRequestBuilder(avro.MediaRequest.Builder value) {
      clearRequest();
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setResponse(avro.MediaResponse value) {
     ...
     * @return This builder.
     */
    public avro.MediaResponse.Builder getResponseBuilder() {
      if (responseBuilder == null) {
        if (hasResponse()) {
          setResponseBuilder(avro.MediaResponse.newBuilder(response));
        } else {
          setResponseBuilder(avro.MediaResponse.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public Builder setResponseBuilder(avro.MediaResponse.Builder value) {
      clearResponse();
    ...
    public MediaBid build() {
      try {
        ...
        if (requestBuilder != null) {
          ...
          record.request = fieldSetFlags()[4] ? this.request : (avro.MediaRequest) defaultValue(fields()[4]);
        }
        if (responseBuilder != null) {
          record.response = this.responseBuilder.build();
        } else {
          record.response = fieldSetFlags()[5] ? this.response : (avro.MediaResponse) defaultValue(fields()[5]);
        }
        return record;
      } catch (Exception e) {
