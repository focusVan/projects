...
public class MediaResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public avro.Monitor monitor;
  ...
  public void put(int field$, Object value$) {
    ...
    case 15: monitor = (avro.Monitor)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public avro.Monitor getMonitor() {
    return monitor;
  }
   ...
   * @param value the value to set.
   */
  public void setMonitor(avro.Monitor value) {
    this.monitor = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MediaResponse>
    ...
    private avro.Monitor monitor;
    private avro.Monitor.Builder monitorBuilder;
    ...
    private Builder(Builder other) {
      ...
      if (other.hasMonitorBuilder()) {
        this.monitorBuilder = avro.Monitor.newBuilder(other.getMonitorBuilder());
      }
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setMonitor(avro.Monitor value) {
     ...
     * @return This builder.
     */
    public avro.Monitor.Builder getMonitorBuilder() {
      if (monitorBuilder == null) {
        if (hasMonitor()) {
          setMonitorBuilder(avro.Monitor.newBuilder(monitor));
        } else {
          setMonitorBuilder(avro.Monitor.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public Builder setMonitorBuilder(avro.Monitor.Builder value) {
      clearMonitor();
    ...
    public MediaResponse build() {
      try {
        ...
        if (monitorBuilder != null) {
          ...
          record.monitor = fieldSetFlags()[15] ? this.monitor : (avro.Monitor) defaultValue(fields()[15]);
        }
        return record;
      } catch (Exception e) {
